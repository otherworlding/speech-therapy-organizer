...
// Always need an external app — no viewer support (pptx is content-detected separately)
export const EXTERNAL_EXTS = new Set(['ppt','key','exe','swf','app','docx','doc','xlsx','xls'])
